...
## Esto es una linea editada desde mi casa
...
- **Algorithmic**, (let's say micro-development vs. architecture and macro-development skills). That is, for example the current most used and modern paradigms:
    ...
    - POO: [Java SE](https://java-programming.mooc.fi/)
    - POC: [React JS](https://reactjs.org/) and [React TS](https://www.typescriptlang.org/docs/handbook/react.html)
- **Architecture in mind**: that it, System Design and Design-Patterns
    - DDD: [design a DDD-oriented microservice](https://dotnet.microsoft.com/download/e-book/microservices-architecture/pdf) (Domain-driven design)
...
- **DevOps**, from Test to Deploy, through Documentation
    - [about this site](about/aboutthissite.qmd), for documentation example.
